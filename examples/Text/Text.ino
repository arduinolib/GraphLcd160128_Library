...
void loop() {
    ...
    Lcd.printStr(0,5,"    Draws a Text    ");
    Lcd.printStr(0,7,"   WG160128B-TFH    ");
    Lcd.printStr(0,9," T6963C Controller  ");
	delay(5000);
	Lcd.clearText();
	
    Lcd.printStr(0,0,"Witaj w Arduino    x");
    Lcd.printStr(0,1,"Witaj              x");
    Lcd.printStr(0,2,"Witaj              x");
    Lcd.printStr(0,3,"Witaj              x");
    Lcd.printStr(0,4,"Witaj              x");
    Lcd.printStr(0,5,"Witaj              x");
    Lcd.printStr(0,6,"Witaj              x");
    Lcd.printStr(0,7,"Witaj              x");
    Lcd.printStr(0,8,"Witaj              x");
    Lcd.printStr(0,9,"Witaj              x");
    Lcd.printStr(0,10,"Witaj              x");
    Lcd.printStr(0,11,"Witaj              x");
    Lcd.printStr(0,12,"Witaj              x");
    Lcd.printStr(0,13,"Witaj              x");
    Lcd.printStr(0,14,"Witaj              x");
    Lcd.printStr(0,15,"Witaj              x");
